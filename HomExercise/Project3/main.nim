...
proc main() =
  ...
  ggplot(df1, aes("c","magnetization")) + geom_line() + ggsave("mag.png")
  ggplot(df2, aes("c","suseptibility")) + geom_line() + ggsave("sus.png")
  ggplot(df3, aes("c","cumulant")) + geom_line() + ggsave("cumul.png")
  ggplot(df4, aes("c","specific heat")) + geom_line() + ggsave("heat.png")
